...
<div class="row g-4 mb-4">
    <div class="col-xl-3 col-md-6">
        <div class="stat-card">
            <div class="d-flex align-items-center justify-content-between">
                <div>
                    <span class="text-muted small fw-semibold">Total Properties</span>
                    <h3 class="fw-bold mb-0">{{ $properties->total() }}</h3>
        ...
        <div class="stat-card">
            <div class="d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <h3 class="fw-bold mb-0">{{ $properties->where('status', 'available')->count() }}</h3>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="stat-card">
            <div class="d-flex align-items-center justify-content-between">
                <div>
                    <span class="text-muted small fw-semibold">Sold / Rented</span>
                    <h3 class="fw-bold mb-0">{{ $properties->whereIn('status', ['sold', 'rented'])->count() }}</h3>
                    <small class="text-danger"><i class="fas fa-arrow-down me-1"></i>3.1%</small>
                </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="stat-card">
            <div class="d-flex align-items-center justify-content-between">
                <div>
                    <span class="text-muted small fw-semibold">Featured</span>
                    <h3 class="fw-bold mb-0">{{ $properties->where('is_featured', true)->count() }}</h3>
                        ...
                        <tr class="align-middle">
                            ...
                            <td class="px-4">
                                <div class="d-flex align-items-center gap-2">
                                    <div class="bg-primary text-white rounded-circle d-flex align-items-center justify-content-center flex-shrink-0" 
                                        ...
                                        {{ $property->user ? substr($property->user->name, 0, 1) : 'N' }}
                                    </div>
                                    <div>
                                        <span class="d-block fw-semibold small">{{ $property->user ? $property->user->name : 'N/A' }}</span>
                                        <small class="text-muted">{{ $property->user ? $property->user->email : '' }}</small>
                                    </div>
                                </div>
                            </td>
                            <td class="px-4">
                            ...
                            <td class="px-4 text-center">
                                <div class="d-flex justify-content-center gap-1">
                                    ...
                                    <form action="{{ route('admin.properties.delete', $property->id) }}" method="POST" style="display: inline-block;">
                                                @csrf
                                                @method('DELETE')
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div>
                <span class="text-muted small">
                    Showing <strong>{{ $properties->firstItem() ?? 0 }}</strong> 
                    to <strong>{{ $properties->lastItem() ?? 0 }}</strong> 
