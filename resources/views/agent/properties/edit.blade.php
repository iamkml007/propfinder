...
@section('page-subtitle', 'Update property details')
        ...
        <div class="table-card">
            <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-3">
                <div>
                    ...
                    <small class="text-muted">Update the property details</small>
                </div>
                <div>
                    <a href="{{ route('agent.properties.index') }}" class="btn btn-outline-secondary btn-sm">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control @error('price') is-invalid @enderror" 
                                           ...
                                           value="{{ old('price', $property->price) }}" step="0.01" required>
                                </div>
                                @error('price')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control @error('area') is-invalid @enderror" 
                                           ...
                                           value="{{ old('area', $property->area) }}" step="0.01">
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                                ...
                                <textarea name="address" id="address" rows="2" 
                                          ...
                                          placeholder="Enter full address" required>{{ old('address', $property->address) }}</textarea>
                                @error('address')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-8">
                                ...
                                <textarea name="description" id="description" rows="4" 
                                          ...
                                          placeholder="Write a detailed description of the property..." required>{{ old('description', $property->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="mb-2">
                                    ...
                                    @else
                                        <div class="bg-light rounded-3 d-flex align-items-center justify-content-center mt-1" 
                                ...
                                <div class="upload-area" id="uploadArea">
                                    <div class="text-center py-3">
                                        <i class="fas fa-cloud-upload-alt fa-2x text-muted mb-1 d-block"></i>
                                        <p class="mb-1 small fw-semibold">Click or drag to upload new</p>
                                ...
                                <div id="imagePreview" class="mt-2" style="display: none;">
                                    <div class="position-relative d-inline-block">
                                        <img id="previewImg" src="#" alt="Preview" 
                                             class="rounded-3 border" style="max-width: 100%; max-height: 120px;">
                            ...
                            <div class="col-md-3">
                                <div class="form-check form-switch">
                                    ...
                                    <input type="checkbox" class="form-check-input @error('is_published') is-invalid @enderror" 
                                           ...
                                           {{ old('is_published', $property->is_published) ? 'checked' : '' }}>
